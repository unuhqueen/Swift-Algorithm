...
print(solutionQueueRight(A: [1, 2, 3, 4, 5], K: 1)) // [5, 1, 2, 3, 4]
print(solutionQueueRight(A: [1, 2, 3, 4, 5], K: 2)) // [4, 5, 1, 2, 3]
print(solutionQueueRight(A: [1, 2, 3, 4, 5], K: 3)) // [3, 4, 5, 1, 2]

print(solutionQueueRight(A: [3, 8, 9, 7, 6], K: 3)) // [9, 7, 6, 3, 8]
